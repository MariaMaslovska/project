  ...
  actions: {
    getTags({ commit, state }) {
      ...
      return new Promise((resolve, reject) => {
        http.get("/api/content/vue-suffix/article-category").then(
          r => {
    ...
    getArticles({ commit, state }) {
      ...
      return Promise.all([
        new Promise((resolve, reject) => {
          http.get("/api/content/vue-suffix/articles").then(
            r => {
    ...
    getArticleBySlug({ commit }, slug) {
      return new Promise((resolve, reject) => {
        http
          .get("/api/content/vue-suffix/articles", {
            params: {
    ...
    getArticlesByTag({ commit }, tagId) {
      ...
      return Promise.all([
        new Promise((resolve, reject) => {
          http.get("/api/content/vue-suffix/articles", objectWithSettings).then(
            r => {
